...
class Config:
    ...
    @classmethod
    def db_validate(cls):
        """Ensures all required settings for the database are present"""
    ...
    def auth_validate(cls):
        """Ensures all required settings for the twilio connection are present"""
    ...
    @property
    def DB_URL(self):
        """Dynamic URL generation to ensure it uses the latest class attributes"""
